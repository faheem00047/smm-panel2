...
<div class="container-fluid">
   <div class="row">
      <div class="col-lg-12">
    <h1>Proxy Düzenleme Alanı</h1>
    <hr>
    <div class="alert alert-info">Örnek Ekleme :  ["213.177.105.14:1080","212.192.202.207:4550"]<br>
   Başında ve sonundaki [ ] işaretlerini koymayı unutmayınız</div>
   <div class="alert alert-warning">Ücretsiz IPV6 Proxy için <a href="https://free-proxy-list.net">BURAYA</a> Tıklayabilirsiniz. 1 Tanesini yazmanız yeterli olacaktır.
   <hr>
<strong>  Proxy özelliği sorunsuzdur eğer çalışmıyorsa proxynizde sorun var demektir.</strong> </div>
<?php
...
{ 
  ...
  if(!$yazdir) 
    echo '<br><br><div class="alert alert-danger"><strong>BAŞARISIZ!</strong><br> İşlem başarısız.<br> 3 Saniye Sonra Yönlendiriliyorsunuz....</div>
    <meta http-equiv="refresh" content="3;">'; 
  else 
    echo '<br><br><div class="alert alert-success"><strong>BAŞARILI!</strong><br> İşlem başarılı.<br> 3 Saniye Sonra Yönlendiriliyorsunuz....</div>
    <meta http-equiv="refresh" content="3;">
'; 
...
<br>
<button class="btn btn-primary" type="submit">Güncelle</button><br><br>
</form>';  
?>
</div></div>
</div>
