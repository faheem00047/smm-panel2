        ...
        <tbody>
          <?php foreach($kuponlar as $kupon ): ?>
              <tr>
                 ...
                 <td><input type="hidden" name="kupon_id" value="<?php echo $kupon["id"] ?>"><button type="submit" class="btn btn-default btn-xs dropdown-toggle btn-xs-caret">SİL</button></td>
   ...
   <table class="table report-table" style="border:1px solid #ddd">
      <thead>
         <tr>
            ...
            <th width="33%">Üye Numarası</th>
            <th width="15%">Kupon Kodu</th>
            <th width="33%">Tutar</th>
            <th></th>
         </tr>
      </thead>
